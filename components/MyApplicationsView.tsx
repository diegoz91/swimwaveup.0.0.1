...
export const MyApplicationsView: React.FC<MyApplicationsViewProps> = ({ 
    ...
    return (
        <div className="max-w-4xl mx-auto w-full pb-20 md:pb-8">
            <button 
                onClick={onBack} 
                className="mb-6 text-blue-600 font-semibold hover:underline flex items-center gap-2 group transition-all"
            >
                    ...
                    {filters.map(filter => {
                        ...
                        return (
                            <button
                                ...
                                className={`whitespace-nowrap px-1 py-4 text-sm sm:text-base font-bold border-b-2 transition-all flex items-center gap-2 ${
                                    isActive 
            ...
            {filteredApplications.length > 0 ? (
                ...
                <div className="text-center py-16 px-6 bg-white border border-slate-200 rounded-2xl shadow-sm">
                    ...
                    {activeFilter === 'all' && (
                        <button 
                            onClick={onBack}
                            className="mt-6 bg-blue-600 text-white font-bold px-6 py-2.5 rounded-full hover:bg-blue-700 transition shadow-sm"
                        >
                            Esplora Offerte
                        </button>
                    )}
